...
const EditGroupe = () => {
    ...
    const groupName = searchParams.get('groupName');    
        axios.patch('http://localhost:8000/publicGroup/editGroup', {
            groupName,
            newName: newname
    },
    {
  ...
  return (
    <div className="h-screen w-screen ">
      <Header title="Edit Group"/>
        ...
        <h1 className="text-xl font-semibold text-[#112377]">Modifier le nom du groupe</h1>
        ...
        />
      <button disabled={isdisabled} onClick={handleClick} className={`text-white ${!isdisabled ? "bg-[#112377] hover:bg-blue-800" : " bg-gray-400"}    rounded-lg text-2xl font-semibold  py-3`}>Modifier</button>
      </div>
    </div>
  )
}
