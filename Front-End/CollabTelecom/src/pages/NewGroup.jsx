...
const NewGroup = () => {
  ...
  return (
    <div className="flex flex-col h-screen">
      <Header isButtonDisabled={isButtonDisabled} nameOfGroup={nameOfGroup} membersToAdd={membersToAdd}/>
      <NameInput nameOfGroup={nameOfGroup} setNameOfGroup={setNameOfGroup} />
      <NewMembersList membersToAdd={membersToAdd} setmembersToAdd={setmembersToAdd}/>
      <SearchFreind setSearchTerm={setSearchTerm}/>
      <ContactsToAdd contactsList={contactsList} membersToAdd={membersToAdd} setmembersToAdd={setmembersToAdd}/>
    </div>
  );
};
