...
const PrivateChat = () => {
  ...
  useEffect(() => {
    ...
    setreceiverId(id);
    axios
      .get(`https://auth-ivbz.onrender.com/PrivateChat?freindId=${id}`, {
    ...
    <div className="h-[100dvh]  flex flex-col">
      ...
      <div className=" overflow-y-auto w-full h-full ">
        ...
        <div ref={messagesEndRef}>
          {isTyping && (
            <div className="animate-typing text-gray-500 pl-4 py-1 text-lg font-medium animate-pulse text-start">
              Typing...
            </div>
          )}
        </div>
