...
const Profile = () => {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      axios
        .get("https://auth-ivbz.onrender.com/profile", {
          headers: {
          ...
          <div className="bg-gray-100 h-[100dvh] flex flex-col items-center overflow-hidden ">
            <div className=" w-full h-176 bg-blue-800  pr-[18px] pt-[21px] pb-[114px] flex justify-end items-center">
              <Link
                ...
                className="bg-white rounded-3xl p-2.5 flex justify-center items-center"
              >
                <SquarePen color="#0B4C8C" />
              </Link>
            </div>

            <UserInfo name={userInfo.username} status={userInfo.email} />
            {/* menu div */}
